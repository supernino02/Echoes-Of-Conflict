...
- **[Final Mobile-Optimized Version](website.html)**: The completed version of the project, specifically optimized for visualization and interaction on mobile screens.
- **[Preliminary Desktop Version](old_website.html)**: An earlier version of the project, designed natively for larger monitors, featuring a slightly different layout.
